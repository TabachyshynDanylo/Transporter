...
<body>
	<div class="container">
		<div class="row">
		<div class="col-3">
				<form:form modelAttribute="filter" action="/admin/model"
					method="GET">
			...
			<div class=" row">
				...
				<div class="form-group row">
					<div class="col-10 offset-sm-2">
						...
						<a href="/admin/model/cancel<custom:allParams/>" class="btn btn-outline-warning btn-sm">Cancel</a>
					</div>
				</div>
			</form:form>
		</div>
				...
				<table class="table table-bordered">
					...
					<tr>
						...
						<td class="text-center"><a
							href="/admin/model/update/${model.id}<custom:allParams/>"
							class="btn btn-outline-warning btn-sm">Update</a> <a
							href="/admin/model/delete/${model.id}<custom:allParams/>"
