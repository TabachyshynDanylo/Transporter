...
<body>
	<div class="container">
		<div class="row">
		<div class="col-3">
				<form:form modelAttribute="filter" action="/admin/city"
					method="GET">
			...
			<div class=" row">
				...
				<div class="form-group row">
					<div class="col-10 offset-sm-2">
						...
						<a href="/admin/city/cancel<custom:allParams/>" class="btn btn-outline-warning btn-sm">Cancel</a>
					</div>
				</div>
			</form:form>
		</div>
		...
		<div class="row">
			<div class="col-9">
				<table class="table table-bordered">
					...
					<c:forEach var="city" items="${city's.content}">
					<tr>
						<td>${city.name}</td>
						<td class="text-center"><a
							href="/admin/city/update/${city.id}<custom:allParams/>"
							class="btn btn-outline-warning btn-sm">Update</a> <a
							href="/admin/city/delete/${city.id}<custom:allParams/>"
			...
			<div class="col-3">
				<div class="row">
					...
					<div class="col-6 text-center">
						<custom:size posibleSizes="1,2,5,10" size="${city's.size}" />
					</div>
				</div>
			</div>
		</div>
