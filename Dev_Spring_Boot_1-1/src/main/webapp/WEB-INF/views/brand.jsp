...
<body>
	<div class="container">
		<div class="row">
			<div class="col-3">
				<form:form modelAttribute="filter" action="/admin/brand"
					method="GET">
			...
			<div class="col-9">
				<form:form action="/admin/brand" method="POST"
					...
					<div class="form-group row">
						<div class="col-10 offset-sm-2">
							...
							<a href="/admin/brand/cancel<custom:allParams/>"
				...
				<table class="table table-bordered">
					...
					<c:forEach var="brand" items="${brands.content}">
						<tr>
							...
							<a	href="/admin/brand/update/${brand.id}<custom:allParams/>"
								class="btn btn-outline-warning btn-sm">Update</a> 
							<a	href="/admin/brand/delete/${brand.id}<custom:allParams/>"
